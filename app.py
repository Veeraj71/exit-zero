...
scenarios = [
    {
        "id": 1,
        "problem": "The web server is down, and you suspect port 80 is already in use by another process. How do you check what is listening on port 80?",
        "accepted_commands": ["netstat", "ss", "lsof"]
    },
    {
        "id": 2,
        "problem": "An application is running out of disk space because of a massive log file. You need to find files larger than 100MB in /var/log. What command do you use?",
        "accepted_commands": ["find"]
    },
    {
        "id": 3,
        "problem": "A developer pushed code that broke the backend, and you need to see the container logs for a Docker container named 'api-server'. What do you type?",
